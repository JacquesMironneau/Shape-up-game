...
public class RectangleBoard extends AbstractBoard
{
     ...
     * @return the score for the board and the given victory card
     */
    @Override
    ...
    public boolean isCardAdjacent(Coordinates coordinates)
    {
        ...
        // Check if the placed card contains an entry for the adjacent coordinates
        for (int i = 0; i < 4; ++i)
        {
    ...
    public void display()
    {
        ...
        // Print the board with ascii-art and printing space for empty coordinates
