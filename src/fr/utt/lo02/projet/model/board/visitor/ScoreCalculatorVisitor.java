...
import fr.utt.lo02.projet.model.board.Card.Color;
import fr.utt.lo02.projet.model.board.Card.Filling;
import fr.utt.lo02.projet.model.board.Card.Shape;
 ...
 * This one is the normal version (based on the official rules)
...
public class ScoreCalculatorVisitor implements IBoardVisitor
{
     ...
     * @param isARow,   if the list is a Row list or a Column list
     * @return a color List which match the cards of the row/column.
     */
    private ArrayList<Card.Color> colorListOfOneRow(Map<Coordinates, Card> map, int nb_Box, Coordinates nextCard, boolean isARow)
    {
        ArrayList<Card.Color> colorList = new ArrayList<>();
    ...
    {
        ArrayList<Card.Shape> shapeList = new ArrayList<>();
        for (int i = 0; i < nb_Box; i++)
        {
            Coordinates coord;
            if (isARow)
    ...
    {
        ArrayList<Card.Filling> fillingList = new ArrayList<>();
        for (int i = 0; i < nb_Box; i++)
        {
            Coordinates coord;
            if (isARow)
     ...
     * @param color, the color of the victory card
     * @return the score of the color list
     */
    private int calculateScoreOfColorRow(ArrayList<Card.Color> list, int MAX, Card.Color color)
    {
     ...
     * @param MAX,   the number of values to compare
     * @param shape, the shape of the victory card
     * @return the score of the shape list
     */
    private int calculateScoreOfShapeRow(ArrayList<Card.Shape> list, int MAX, Card.Shape shape)
    {
     ...
     * @param MAX,     the number of values to compare
     * @param filling, the filling of the victory card
     * @return the score of the filling list
     */
    private int calculateScoreOfFillingRow(ArrayList<Card.Filling> list, int MAX, Card.Filling filling)
    {
        int list_score = 0;
